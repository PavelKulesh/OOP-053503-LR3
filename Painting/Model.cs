...
namespace Painting
{
    public class Model
    {
        ...
        public void Serialize()
        {
            ...
            using (StreamWriter writer = new StreamWriter(@"C:\Users\pavel\Desktop\LR3\Painting\Serializer\Json.json", false))
            {
        ...
        {
            using (StreamReader reader = new StreamReader(@"C:\Users\pavel\Desktop\LR3\Painting\Serializer\Json.json"))
            {
                string js;
                string t = "";
